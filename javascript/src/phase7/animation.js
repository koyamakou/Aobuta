...
function animation() {
  ...
  if (windowWidth > 540) {
    ...
    if (!　syndrome.includes('span')) {
      ...
      comAnimation.dispWrite_Horizontal( element.children[0], element.children[1]);
    }
  } else {
    ...
    if (!title_line1.includes('span')) {
      ...
      comAnimation.dispWrite_Vertical(element.children[0].children[0], element.children[0].children[1],
